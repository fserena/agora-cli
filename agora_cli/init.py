...
@click.option('--repo-sparql-host', default='http://localhost:7200/repositories/tds')
@click.option('--repo-update-host', default='http://localhost:7200/repositories/tds/statements')
